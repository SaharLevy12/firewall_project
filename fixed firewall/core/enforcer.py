...
class Enforcer:
    ...
    def update_rules(self, rules):
        self.blocked_ports_in = set(rules.get("blocked_ports_in", []))
        self.blocked_ports_out = set(rules.get("blocked_ports_out", []))

        self.blocked_protocols_in = set(rules.get("blocked_protocols_in", []))
        self.blocked_protocols_out = set(rules.get("blocked_protocols_out", []))
